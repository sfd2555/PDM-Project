...
public class SessionController {
        ...
        @GetMapping("/")
        public ResponseEntity<Session> getSession(@RequestParam("accountId") String accountId, @RequestParam("bookId") String bookId, @RequestParam("startTime") java.sql.Timestamp startTime) {
            LOG.info("GET session?accountId=" + accountId + "&bookId" + bookId + "&startTime=" + startTime);
            Session result = sessionDAO.getSession(accountId, bookId, startTime);
        ...
        @PostMapping("/")
        public ResponseEntity<Boolean> addSession(@RequestParam("accountId") String accountId, @RequestParam("bookId") String bookId, @RequestParam("startTime") java.sql.Timestamp startTime, @RequestParam("progress") int progress) {
            LOG.info("POST session?accountId=" + accountId + "&bookId" + bookId + "&startTime=" + startTime);
            boolean result = sessionDAO.addSession(accountId, bookId, startTime, startTime, progress);
